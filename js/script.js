...
const MAXIMOS_INTENTOS = 5, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./img/signo.jpg"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "Desarollador",
                html: `Creado por <strong>Luis Alejandro Caisatoa Silva</strong>
                <br>
                <br>
                <h5>Videos recomendados:</h5>
                Niños protejan sus datos personales
                <div>
                    <a href="https://youtu.be/hy_dmT2oGzU">Video 1</a> 
                    <a href="https://youtu.be/AXcAHmnim2Y">Video 2</a> 
                    <a href="https://youtu.be/qbb3AJr18kw">Video 3</a> 
                    <a href="https://youtu.be/_GsevaA6oPs">Video 4</a> 
                </div>
                `,
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "¡Perdiste!",
                    html: `
                <img class="img-fluid" src="./img/perdedor.jpg" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                <img class="img-fluid" src="./img/ganador.png" alt="Ganaste">
